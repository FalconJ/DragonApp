 ...
 * {@link PersonalityFragment.OnFragmentInteractionListener} interface
...
public class PersonalityFragment extends Fragment {
    ...
    ListView perList;
    String[] names = {"per traits","per traits","per traits"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        perList = (ListView) v.findViewById(R.id.perList);
        CustomListView2 customListView2 = new CustomListView2((Activity) getContext(),names);
        perList.setAdapter(customListView2);
        return v;
    }
